...
namespace SimpleHttpServer
{
    ...
    {
        private const int DefaultRequestElementsLength = 3;
        ...
        private HttpRequest GetRequest(Stream inputStream)
        {
            ...
            //First line is in format: “{Method} {URL} {ProtocolVersion}”
            //For example, “GET / users / all HTTP / 1.0”
            while (tokens.Length != DefaultRequestElementsLength)
            {
