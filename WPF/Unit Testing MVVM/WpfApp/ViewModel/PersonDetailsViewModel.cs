...
namespace WpfApp.ViewModel
{
	public class PersonDetailsViewModel : ViewModelBase
	{
		...
		public PersonDetailsViewModel(IPersonService personService, IDispatcher dispatcher, 
            IEventAggregator aggregator, IDialogService dialogService) 
			: base(personService, dispatcher, aggregator, dialogService)
		{
			aggregator.GetEvent<SelectedPersonChangeEvent>().Subscribe(OnSelectedPersonChanged, 
		...
		{
			PersonDialogViewModel viewModel = new PersonDialogViewModel(personService, dispatcher, 
                aggregator, dialogService, null);
		...
		{
			PersonDialogViewModel viewModel = new PersonDialogViewModel(personService, dispatcher, 
                aggregator, dialogService, person);
		...
		{
			if (dialogService.ShowMessageBox(this, "Are you sure?", "Confirm deletion", 
                ...
                System.Windows.MessageBoxImage.Question) == System.Windows.MessageBoxResult.Yes)
			{
				if (personService.DeletePerson(this.person.Id))
				{
					...
					dialogService.ShowMessageBox(this, "Person successfully deleted", "Success", 
                        System.Windows.MessageBoxButton.OK, System.Windows.MessageBoxImage.Information);
				}
				else
				{
					dialogService.ShowMessageBox(this, "Error deleting person", "Error", 
