...
namespace WpfApp.ViewModel
{
	public class PersonDialogViewModel : ViewModelBase
	{
		...
		public PersonDialogViewModel(IPersonService personService, IDispatcher dispatcher, 
            IEventAggregator aggregator, IDialogService dialogService, Person person)
